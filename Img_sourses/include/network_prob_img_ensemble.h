...
class newtwork_prob_img_ensemble: public basic_prob_img
{
    
public:
    newtwork_prob_img_ensemble(){}
    ...
    virtual void load_probs_from_file(vector<string> probs_data, string borders_filename);
